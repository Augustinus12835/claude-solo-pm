...
started: {ISO datetime}      # When task-start was run
completed: {ISO datetime}    # When task-close was run
branch: task/feature-001     # Git branch name
prd: .claude/prds/feature.md # Reference to PRD
...
created: {ISO datetime}
spec_file: path/to/spec.md   # Reference to original spec
---
```
